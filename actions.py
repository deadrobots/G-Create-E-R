...
def temp_init(icpp):
    ...
    enable_servos()
    p.cameraInit()
    p.set_first_position(color=c.GREEN)
    wait_for_button()
...
def getCrates():  # break this function into smaller bites... make driveToCrates, getCrates, turnAround,etc
    ...
    # cpp.drive(0, 0)
    cpp.drive_distance(2, 20)
    moveServo(c.servoCrateArm, c.crateArmMid + 400, 2)
    cpp.rotate(90, 30)
