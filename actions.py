...
def getCrates():
    ...
    moveServo(c.servoCrateClaw, c.crateGrab, 15)  #grab stacked crates
    msleep(700)
    cpp.drive_distance(-6.5, 30)
...
def goYellowFirst():
    ...
    cpp.drive_distance(-4, 35) #pushing crate into yellow zone
